...
.tracking-toggle-container {
    ...
    background: linear-gradient(135deg, rgb(95 219 95 / 20%) 0%, rgb(95 219 95 / 15%) 100%);
    border: 1.5px solid rgb(95 219 95 / 50%);
    box-shadow: 0 2px 8px rgb(95 219 95 / 25%);
}

.tracking-toggle-container:hover {
    background: linear-gradient(135deg, rgb(95 219 95 / 30%) 0%, rgb(95 219 95 / 20%) 100%);
    border-color: rgb(95 219 95 / 70%);
    box-shadow: 0 4px 12px rgb(95 219 95 / 35%);
...
.tracking-toggle-container.is-tracked {
    background: linear-gradient(135deg, rgb(239 68 68 / 25%) 0%, rgb(220 38 38 / 18%) 100%);
    border-color: rgb(239 68 68 / 60%);
    box-shadow: 0 2px 8px rgb(239 68 68 / 30%);
}

.tracking-toggle-container.is-tracked:hover {
    background: linear-gradient(135deg, rgb(239 68 68 / 35%) 0%, rgb(220 38 38 / 25%) 100%);
    border-color: rgb(239 68 68 / 80%);
