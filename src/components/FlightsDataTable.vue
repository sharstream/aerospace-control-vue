...
.expand-btn {
    ...
    align-items: center;
    gap: 10px;
    background: linear-gradient(135deg, rgb(74 157 215 / 25%) 0%, rgb(74 157 215 / 15%) 100%);
...
.expand-btn:hover {
    background: linear-gradient(135deg, rgb(74 157 215 / 35%) 0%, rgb(74 157 215 / 25%) 100%);
