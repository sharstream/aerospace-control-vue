...
.delay-table thead {
    background: linear-gradient(135deg, rgb(51 51 51 / 80%) 0%, rgb(42 42 42 / 90%) 100%);
}
...
.delay-table th {
    ...
    font-weight: 700;
    letter-spacing: 1px;
    border-bottom: 2px solid rgb(74 157 215 / 30%);
}
...
.success-icon {
    color: #4ade80;
    margin-bottom: 20px;
    filter: drop-shadow(0 0 8px rgb(74 222 128 / 40%));
}
