        ...
        <div class="kpi-dashboard">
            ...
            <div class="kpi-card success">
                <div class="kpi-header">
                    <div
                        class="kpi-icon"
                        style="background: rgb(74 222 128 / 15%); color: #4ade80;"
                    >
                        <svg
                            fill="currentColor"
                            viewBox="0 0 24 24"
            ...
            >
                <div class="kpi-header">
                    <div
                        class="kpi-icon"
                        style="background: rgb(245 158 11 / 15%); color: #f59e0b;"
                    >
                        <svg
                            fill="currentColor"
                            viewBox="0 0 24 24"
                ...
                <div class="aerospace-metrics-grid">
                    <div class="metric-tile">
                        <div
                            ...
                            style="background: rgb(74 157 215 / 15%); color: #4a9dd7;"
                        >
                            <svg
                                fill="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <div class="metric-tile">
                        <div
                            class="metric-icon-circle"
                            style="background: rgb(139 92 246 / 15%); color: #8b5cf6;"
                        >
                            <svg
                                fill="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <div class="metric-tile">
                        <div
                            class="metric-icon-circle"
                            style="background: rgb(236 72 153 / 15%); color: #ec4899;"
                        >
                            <svg
                                fill="currentColor"
                                viewBox="0 0 24 24"
                    ...
                    <div class="metric-tile">
                        <div
                            class="metric-icon-circle"
                            style="background: rgb(59 130 246 / 15%); color: #3b82f6;"
                        >
                            <svg
                                fill="currentColor"
                                viewBox="0 0 24 24"
...
.flight-card:hover {
    ...
    box-shadow: 0 8px 24px rgb(74 157 215 / 30%);
    border-color: #4a9dd7;
}
