...
.legend-panel {
    ...
    border-radius: 12px;
    box-shadow: 0 4px 24px rgb(0 0 0 / 40%), 0 0 0 1px rgb(74 157 215 / 10%);
    z-index: 900;
    border: 1px solid rgb(74 157 215 / 15%);
    overflow: hidden;
...
.weather-indicator.storm {
    background: radial-gradient(circle, rgb(239 68 68 / 30%) 0%, rgb(220 38 38 / 10%) 100%);
    border: 2px solid #ef4444;
}

.weather-indicator.turbulence {
    background: radial-gradient(circle, rgb(245 158 11 / 30%) 0%, rgb(217 119 6 / 10%) 100%);
...
.ai-nav-button {
    ...
    box-shadow: 0 2px 8px rgb(74 157 215 / 30%);
}

.ai-nav-button:hover {
    transform: translateY(-2px);
    box-shadow: 0 4px 12px rgb(74 157 215 / 50%);
}
