                ...
                >
                    ...
                    <div class="flight-item-info">
                        ...
                        <div class="flight-item-airline">
                            {{ airlines[flight.airline]?.name || 'Unknown' }} • {{ flight.aircraft }}
                        </div>
                    </div>
                    <div
                        v-if="flight.systems"
...
.flights-view {
    ...
    padding-bottom: 90px;
    overflow-y: auto;
    background: linear-gradient(180deg, rgb(10 22 40 / 95%) 0%, rgb(26 26 26 / 95%) 100%);
...
.flight-list-item {
    background: linear-gradient(135deg, rgb(42 42 42 / 60%) 0%, rgb(31 31 31 / 60%) 100%);
...
.flight-list-item::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at top right, rgb(255 255 255 / 2%), transparent);
    pointer-events: none;
}

.flight-list-item:hover {
    border-color: rgb(74 157 215 / 30%);
...
.health-bar-fill.operational {
    ...
    box-shadow: 0 0 8px rgb(74 222 128 / 40%);
}
...
.flight-expanded-view {
    margin-top: 20px;
    padding-top: 20px;
    border-top: 2px solid rgb(74 157 215 / 20%);
}

.aircraft-visual-section {
    position: relative;
    background: linear-gradient(135deg, rgb(74 157 215 / 15%) 0%, rgb(74 157 215 / 5%) 100%);
...
.flight-progress-section {
    background: linear-gradient(135deg, rgb(26 38 50 / 60%) 0%, rgb(20 30 40 / 60%) 100%);
    border: 1px solid rgb(255 255 255 / 6%);
    border-radius: 12px;
    padding: 24px;
    margin-bottom: 24px;
...
.seat.occupied {
    background: #4a7ba7;
    border-color: #5a8dc7;
    box-shadow: 0 2px 4px rgb(74 123 167 / 30%);
}
...
.seat.first-class {
    ...
    border-color: #e5c047;
    box-shadow: 0 2px 4px rgb(212 175 55 / 30%);
}

.seat.flight-deck {
    background: linear-gradient(135deg, #ef4444 0%, #dc2626 100%);
    border-color: #f87171;
    box-shadow: 0 2px 4px rgb(239 68 68 / 30%);
}
