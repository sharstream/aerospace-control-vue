...
.kpi-card::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at top right, rgb(255 255 255 / 3%), transparent);
    pointer-events: none;
}
...
.kpi-card.kpi-success:hover {
    ...
    box-shadow: 0 8px 24px rgb(74 222 128 / 15%);
}
...
.kpi-card.kpi-warning:hover {
    ...
    box-shadow: 0 8px 24px rgb(251 191 36 / 15%);
}
...
.airline-item {
    background: linear-gradient(135deg, rgb(42 42 42 / 40%) 0%, rgb(31 31 31 / 40%) 100%);
    border: 1px solid rgb(255 255 255 / 6%);
    border-radius: 16px;
    padding: 24px;
    display: flex;
...
.airline-item::before {
    ...
    position: absolute;
    inset: 0;
    background: radial-gradient(circle at top left, rgb(255 255 255 / 2%), transparent);
    pointer-events: none;
}
